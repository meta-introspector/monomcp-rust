# Cargo2HF Dataset: agentic-core

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/agentic/crates/agentic-core` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/agentic/crates/agentic-core
