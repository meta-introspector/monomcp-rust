# Cargo2HF Dataset: hello-world-mcp-server

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/rust-mcp-sdk/examples/hello-world-mcp-server` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/rust-mcp-sdk/examples/hello-world-mcp-server
