# Cargo2HF Dataset: mcp-attr

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/mcp-attr/mcp-attr` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/mcp-attr/mcp-attr
