# Cargo2HF Dataset: mcp-attr-macros

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/mcp-attr/mcp-attr-macros` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/mcp-attr/mcp-attr-macros
