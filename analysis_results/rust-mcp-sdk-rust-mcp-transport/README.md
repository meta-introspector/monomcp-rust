# Cargo2HF Dataset: rust-mcp-transport

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/rust-mcp-sdk/crates/rust-mcp-transport` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/rust-mcp-sdk/crates/rust-mcp-transport
