# Cargo2HF Dataset: agentic-tui

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/agentic/crates/agentic-tui` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/agentic/crates/agentic-tui
