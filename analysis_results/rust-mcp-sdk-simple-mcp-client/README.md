# Cargo2HF Dataset: simple-mcp-client

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/rust-mcp-sdk/examples/simple-mcp-client` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/rust-mcp-sdk/examples/simple-mcp-client
