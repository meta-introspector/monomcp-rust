# Cargo2HF Dataset: monomcp-core

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/monomcp-core` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/monomcp-core
