# Cargo2HF Dataset: mcp-discovery

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/mcp-discovery` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/mcp-discovery
