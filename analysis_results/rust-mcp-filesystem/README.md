# Cargo2HF Dataset: rust-mcp-filesystem

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/rust-mcp-filesystem` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/rust-mcp-filesystem
