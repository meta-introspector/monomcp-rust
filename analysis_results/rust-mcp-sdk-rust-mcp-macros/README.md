# Cargo2HF Dataset: rust-mcp-macros

This dataset contains comprehensive analysis data extracted from the Cargo project `monomcp/rust-mcp-sdk/crates/rust-mcp-macros` using the cargo2hf tool.

## Dataset Overview

- **Source Project**: monomcp/rust-mcp-sdk/crates/rust-mcp-macros
